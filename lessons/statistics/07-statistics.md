...
Vdd**Bayesiam probability of twin type**

First construct a row for each hypothesis (twin is either A. fraternal, of A. identical) and a column for each term in 
Bayes's theorem
